...
/**
 * Download source type enum.
 * Phase 1 Enhancement (from PCL):
 * - Dynamic source selection based on network latency
 * - Automatic fallback to alternate sources
 * - China mirror priority for domestic users
 * 
 * @see <a href="https://github.com/Meloong-Git/PCL">PCL ModDownload.vb DlSourceLoader</a>
 */
public enum DownloadType {
    ...
    Modrinth("Modrinth", new ModrinthDownloadProvider());
    ...
    /**
     * Get the download provider for this type.
     * This is a convenience method that delegates to getProvider().
     * 
     * @return the IDownloadProvider for this download type
     */
    ...
    /**
     * Check if this download type uses a China mirror.
     * Used for automatic source selection optimization.
     * 
     * @return true if this is a China-based mirror
     */
    public boolean isChinaMirror() {
        return provider.isChinaMirror();
    }
