...
public class BMCLAPIDownloadProvider extends IDownloadProvider {
    ...
    public int getPriority() {
        return 60; // BMCLAPI is China mirror, slightly lower priority than Mojang
    }

    @Override
    public List<IDownloadProvider> getFallbackProviders() {
        // Fallback to Mojang when BMCLAPI fails
        return Arrays.asList(new MojangDownloadProvider());
    }
