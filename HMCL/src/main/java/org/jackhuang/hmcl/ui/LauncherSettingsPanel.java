...
public class LauncherSettingsPanel extends RepaintPage {
            ...
            .addGroup(pnlGeneralLayout.createSequentialGroup()
                ...
                .addGroup(pnlGeneralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlGeneralLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlGeneralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlGeneralLayout.createSequentialGroup()
                                .addComponent(sldDownloadSpeed, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lblDownloadSpeedValue)
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(pnlGeneralLayout.createSequentialGroup()
        ...
        pnlGeneralLayout.setVerticalGroup(
            ...
            .addGroup(pnlGeneralLayout.createSequentialGroup()
                ...
                .addGroup(pnlGeneralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(sldDownloadSpeed, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblDownloadSpeedValue))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnlGeneralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void initDownloadSpeedSlider() {
        lblDownloadSpeed.setText(C.i18n("launcher.download_speed"));
        sldDownloadSpeed.setMinimum(0);
        sldDownloadSpeed.setMaximum(42);
        sldDownloadSpeed.setValue(Settings.getInstance().getDownloadSpeed());
        sldDownloadSpeed.setMajorTickSpacing(10);
        sldDownloadSpeed.setMinorTickSpacing(1);
        sldDownloadSpeed.setPaintTicks(true);
        sldDownloadSpeed.setSnapToTicks(false);
        sldDownloadSpeed.addChangeListener(e -> {
            int v = sldDownloadSpeed.getValue();
            Settings.getInstance().setDownloadSpeed(v);
            lblDownloadSpeedValue.setText(getSpeedLabel(v));
        });
        lblDownloadSpeedValue.setText(getSpeedLabel(Settings.getInstance().getDownloadSpeed()));
    }

    private static String getSpeedLabel(int v) {
        if (v >= 42) return C.i18n("settings.download_speed.unlimited");
        int mbps = 0;
        if (v <= 14)      mbps = (v + 1) * 100;       // 100KB/s ~ 1500KB/s
        else if (v <= 31) mbps = (v - 11) * 500;      // 2000KB/s ~ 10000KB/s
        else              mbps = (v - 21) * 1000;     // 11000KB/s ~ 20000KB/s
        return String.format("%.1f MB/s", mbps / 1000.0);
    }
